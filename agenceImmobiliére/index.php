            ...
            <?php
                ...
                echo '<nav>';
                    ...
                    foreach ($menu as $nav)
                    {
                        if ($nav['id'] == '1')
                        {
                            echo '<li role="presentation" class="active"><a href="#' . $nav['id'] . '" data-toggle="tab"> ' . $nav['name'] . ' </a></li>';
                        }
                        else
                        {
                            echo '<li role="presentation"><a href="#' . $nav['id'] . '" data-toggle="tab"> ' . $nav['name'] . ' </a></li>';
                        }
                    }
                    echo '</ul>';
                echo '</nav>';
                echo '<div class="tab-content">';
                    foreach ($menu as $nav)
                    {
                        if ($nav['id'] == '1')
                        {
                            echo '<div class="tab-pane active" id="'. $nav['id'] .'">';
                        }
                        else
                        {
                            echo '<div class="tab-pane" id="'. $nav['id'] .'">';
                        }
                        echo '<div class="row">';
